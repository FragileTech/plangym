...
class PixelObservationWrapper(ObservationWrapper):
    ...
    def __init__(self, env, pixels_only=True, render_kwargs=None, pixel_keys=("pixels",)):
        ...
        elif isinstance(wrapped_observation_space, (spaces.Dict, collections.MutableMapping)):
        ...
        for pixel_key in pixel_keys:
            ...
            if numpy.issubdtype(pixels.dtype, numpy.integer):
                low, high = (0, 255)
            elif numpy.issubdtype(pixels.dtype, numpy.float):
