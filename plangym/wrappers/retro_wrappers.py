...
class StartDoingRandomActions(gym.Wrapper):
    """
    ...
    def some_random_steps(self):
        ...
        n = numpy.random.randint(self.random_steps)
...
def wrap_deepmind_retro(env, scale=True, frame_stack=4):
    """
    Configure environment for retro games, using config similar to \
    DeepMind-style Atari in wrap_deepmind.
    """
    env = WarpFrame(env)
