...
from plangym.videogames.super_mario_gym.mario_gym_env import SuperMarioBrosEnv

gym_super_mario_bros.SuperMarioBrosEnv = SuperMarioBrosEnv
...
gym_super_mario_bros.make = gym.make
